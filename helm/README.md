...
![Version: v0.16.1](https://img.shields.io/badge/Version-v0.16.1-informational?style=flat-square) ![AppVersion: v0.16.0](https://img.shields.io/badge/AppVersion-v0.16.0-informational?style=flat-square)
...
```console
$ helm install kserve oci://ghcr.io/kserve/charts/kserve --version v0.16.1
```
...
| kserve.controller.tag | string | `"v0.16.0"` | KServe controller contrainer image tag. |
...
| kserve.router.tag | string | `"v0.16.0"` |  |
...
| kserve.servingruntime.xgbserver.tag | string | `"v0.16.0"` |  |
| kserve.storage.additionalStorage | object | `{}` |  |
...
| kserve.storage.supportedUriFormats | list | `[{"prefix":"gs://"},{"prefix":"s3://"},{"prefix":"hdfs://"},{"prefix":"hf://"},{"prefix":"webhdfs://"},{"regex":"https://(.+?).blob.core.windows.net/(.+)"},{"regex":"https://(.+?).file.core.windows.net/(.+)"},{"regex":"https?://(.+)/(.+)"}]` | Specifies the list of supported Uri format on default clusterStorageContainer |
| kserve.storage.supportsMultiModelDownload | bool | `true` |  |
| kserve.storage.tag | string | `"v0.16.0"` |  |
| kserve.storage.uidModelcar | int | `1010` | Model sidecar UID. |
| kserve.storage.workloadType | string | `"initContainer"` |  |
